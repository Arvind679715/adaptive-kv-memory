...
\begin{itemize}
    \item \textbf{Model scale}: Results are validated on TinyLlama-1.1B (GQA), Llama-2-7B (MHA), and Qwen2.5-0.5B (GQA). Evaluation on larger Qwen2.5 variants (7B, 72B) and models with longer native context windows (128K+) would further strengthen generalization claims.
