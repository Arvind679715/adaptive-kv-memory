...
\begin{itemize}
    ...
    \item \textbf{Extended long-context benchmarks}: We evaluate on LongBench (Section~\ref{sec:longbench}), confirming that AKV preserves downstream task quality. Evaluation on additional benchmarks (InfiniteBench, RULER) and at longer contexts (32K+) would further strengthen these findings.
